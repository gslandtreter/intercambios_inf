...
function PrintUserTable() {
    ...
    global $DAO;
    $stmt = $DAO->PrepareStatement("select id, username, email, permissions from users");

    $DAO->ExecuteStatement($stmt);
    $stmt->bind_result($id, $username, $email, $permissions);
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <button type="button" class="btn btn-info" onclick="loadUserAddPage();">Adicionar Usuário</button>
            </div>
        </div>
    </div>
</div>
